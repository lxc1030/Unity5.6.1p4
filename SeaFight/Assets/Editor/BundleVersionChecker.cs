...
public class BundleVersionChecker
{
    ...
    // cs文件路径
    private const string TargetCodeFile = "Assets/Scripts/Version/" + ClassName + ".cs";

    public BundleVersionChecker()
    {
    ...
    private static string GenerateCode(string bundleVersion)
    {
        ...
        code += System.String.Format("\tpublic static string version = \"{0}\";", bundleVersion);
        code += "\n}\n";
        return code;
    }
}
